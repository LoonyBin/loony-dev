...
class SessionView:
    ...
    repo: str | None
    key: str | None
    join_url: str | None  # claude.ai deep-link; null until Claude emits it
    mode: str | None  # e.g. "remote-control"
    updated_at: str | None  # ISO-8601 mtime of remote-control.json (staleness)
    alive: bool | None  # remote-control process running; null if no PID file
